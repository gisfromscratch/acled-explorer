...
#define kApplicationName                "ACLEDExplorer"
#define kApplicationVersion             "1.0"
#define kApplicationDescription         "The ACLED explorer is a desktop map application visualizing occurred events worldwide."
