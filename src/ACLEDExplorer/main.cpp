...
int main(int argc, char *argv[])
{
    ...
    if (processEnvironment.contains("ARCGIS_RUNTIME_LICENSE"))
    {
        ArcGISRuntimeEnvironment::setLicense(processEnvironment.value("ARCGIS_RUNTIME_LICENSE"));
    }

    // Register the map view for QML
    qmlRegisterType<MapQuickView>("Esri.ACLEDExplorer", 1, 0, "MapView");
